...
def create_pull_request(repo_owner, repo_name, base_branch, head_branch, title, body, github_token):
...
create_pull_request(repo_owner, repo_name, base_branch, head_branch, title, body, github_token)
